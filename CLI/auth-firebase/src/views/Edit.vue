<template>
  <div  class="card-header" >
      <h1>
          ...
          <textarea  class="form-control form-control-sm" type="text" v-model="task.nombre" />
           <br><br>
          <button type="submit" class="btn btn-warning"> <i class="fas fa-save fa-2x"></i> Editar</button>
          </form>
      </h1>
  </div>
</template>
